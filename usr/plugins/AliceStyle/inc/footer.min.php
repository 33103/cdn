...
JS;
	...
	public static function TagLog(){
		...
		echo '<script>console.log("\n %c AliceStyle v3.3.2 Pro By 萌卜兔\'s | https://racns.com/374.html","color:#fff;background: linear-gradient(to right , #7A88FF, #d27aff);padding:5px;border-radius: 10px;");</script>';
	}
