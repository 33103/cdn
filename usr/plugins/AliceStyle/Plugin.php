 ...
 * @version <strong style="color:#7682fa;font-family: 楷体;">3.3.2</strong>
 * @update: 2020-8-26
 * @link //racns.com
 */
class AliceStyle_Plugin implements Typecho_Plugin_Interface{
    ...
    public static function config(Typecho_Widget_Helper_Form $form){
		...
		// 在线检查最新版本	参数 '本插件的版本号'
		echo PluginsForm::updata('20200826');
    ...
    public static function render(){
    	...
    	// 更新提示	参数 '本插件的版本号'
		echo PluginsHead::UpdataTips('20200826');
